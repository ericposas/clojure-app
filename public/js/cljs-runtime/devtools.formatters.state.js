...
var G__12556 = (i__5770__auto___12554 + (1));
i__5770__auto___12554 = G__12556;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12325){
var G__12326 = cljs.core.first(seq12325);
var seq12325__$1 = cljs.core.next(seq12325);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12326,seq12325__$1);
}));
...
return cljs.core.some((function (p1__12345_SHARP_){
return (p1__12345_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__12362){
var vec__12364 = p__12362;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12364,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq12351){
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__12421){
var vec__12422 = p__12421;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(0),null);
...
var _STAR_ = (function (p__12430){
var vec__12431 = p__12430;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12431,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12431,(1),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq12411){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12412,G__12413,seq12411__$2);
}));
