...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14876 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14876(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14877 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14877(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14881 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14881(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14882 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14882(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14886 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14886(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14890 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14890(reader);
}
});
...
var G__14956 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14957 = s.append(c);
c = G__14956;
s = G__14957;
continue;
}
