...
var i_17713 = (self__.level + (1));
while(true){
if((i_17713 <= (new_level + (1)))){
(update[i_17713] = self__.header);

var G__17715 = (i_17713 + (1));
i_17713 = G__17715;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17720 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17720[i]));
} else {
x__$2.forward.push((((i < links_17720.length))?(links_17720[i]):null));
}

if((i < links_17720.length)){
(links_17720[i] = x__$2);
} else {
links_17720.push(x__$2);
}
...
var i_17723 = (0);
while(true){
if((i_17723 <= self__.level)){
var links_17725 = (update[i_17723]).forward;
if((x__$1 === (((i_17723 < links_17725.length))?(links_17725[i_17723]):null))){
(links_17725[i_17723] = (x__$1.forward[i_17723]));

var G__17726 = (i_17723 + (1));
i_17723 = G__17726;
continue;
} else {
var G__17727 = (i_17723 + (1));
i_17723 = G__17727;
continue;
}
} else {
...
var G__17730 = nx;
var G__17731 = (level__$1 - (1));
x = G__17730;
level__$1 = G__17731;
continue;
} else {
var G__17732 = x;
var G__17733 = (level__$1 - (1));
x = G__17732;
level__$1 = G__17733;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17736 = nx;
var G__17737 = (level__$1 - (1));
x = G__17736;
level__$1 = G__17737;
continue;
} else {
var G__17738 = x;
var G__17739 = (level__$1 - (1));
x = G__17738;
level__$1 = G__17739;
continue;
}
