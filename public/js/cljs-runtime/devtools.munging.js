...
var o12281 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12281["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12282 = temp__5802__auto____$1;
return (o12282["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11778__auto__ = f;
return (o__11778__auto__["toString"]).call(o__11778__auto__);
} else {
return "";
}
}catch (e12286){var _ = e12286;
return "";
}});
...
try{var o__11778__auto___12656 = t;
(o__11778__auto___12656["cljs$lang$ctorPrWriter"]).call(o__11778__auto___12656,t,writer);
}catch (e12300){var __12657 = e12300;
}
...
var char_code = (function (){var o__11778__auto__ = (new String(char$));
return (o__11778__auto__["charCodeAt"]).call(o__11778__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11778__auto__ = String;
return (o__11778__auto__["fromCharCode"]).call(o__11778__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12331 = num_code;
switch (G__12331) {
case (1):
return (185);
...
var o__11778__auto__ = String;
return (o__11778__auto__["fromCharCode"]).call(o__11778__auto__,superscript_code);
});
/**
...
}catch (e12361){var _e__11814__auto__ = e12361;
return false;
}})())){
...
var vec__12367 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12367,(0),null);
...
var len__5769__auto___12664 = arguments.length;
var i__5770__auto___12665 = (0);
while(true){
if((i__5770__auto___12665 < len__5769__auto___12664)){
args__5775__auto__.push((arguments[i__5770__auto___12665]));

var G__12669 = (i__5770__auto___12665 + (1));
i__5770__auto___12665 = G__12669;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12404){
var vec__12405 = p__12404;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(0),null);
...
var G__12672 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12673 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12672;
remaining_tokens = G__12673;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12399){
var G__12400 = cljs.core.first(seq12399);
var seq12399__$1 = cljs.core.next(seq12399);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12400,seq12399__$1);
}));
...
var vec__12425 = cljs.core.split_with((function (p1__12417_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12417_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12425,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12425,(1),null);
...
var vec__12453 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12681 = cljs.core.rest(remaining_tokens);
var G__12682 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12681;
name_tokens = G__12682;
continue;
} else {
...
var vec__12482 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12482,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12482,(1),null);
var vec__12485 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(1),null);
var vec__12488 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12488,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12488,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12488,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12488,(3),null);
...
var vec__12511 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12511,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12519 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12519,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12519,(1),null);
var vec__12522 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12528 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12528) : devtools.munging.parse_fn_info_deep.call(null,G__12528));
})()));
}
} else {
return fn_info;
...
var G__12702 = (arity + (1));
var G__12703 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12541){
var vec__12542 = p__12541;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12542,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12542,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12560_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12560_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12564_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12564_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12711 = arguments.length;
var i__5770__auto___12712 = (0);
while(true){
if((i__5770__auto___12712 < len__5769__auto___12711)){
args__5775__auto__.push((arguments[i__5770__auto___12712]));

var G__12713 = (i__5770__auto___12712 + (1));
i__5770__auto___12712 = G__12713;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12581){
var vec__12582 = p__12581;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12574){
var G__12575 = cljs.core.first(seq12574);
var seq12574__$1 = cljs.core.next(seq12574);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12575,seq12574__$1);
}));
...
var map__12609 = options;
var map__12609__$1 = cljs.core.__destructure_map(map__12609);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12609__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12609__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12609__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12609__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12610 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(5),null);
...
var o__11778__auto__ = f;
return (o__11778__auto__["getBasis"]).call(o__11778__auto__);
});
/**
...
}catch (e12617){var _e__11814__auto__ = e12617;
...
var G__12732 = (obj[cljs.core.first(path)]);
var G__12733 = cljs.core.rest(path);
obj = G__12732;
path = G__12733;
continue;
} else {
...
var _STAR_ = (function (accum,p__12638){
var vec__12639 = p__12638;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12639,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12639,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12642){
var vec__12643 = p__12642;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(2),null);
...
var post_process = (function (p__12651){
var vec__12652 = p__12651;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12652,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12652,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12646_SHARP_){
return (obj[cljs.core.first(p1__12646_SHARP_)]);
}),sorted_matches);
