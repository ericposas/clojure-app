...
var G__12731 = devtools.prefs.pref(v);
v = G__12731;
continue;
} else {
return v;
...
}catch (e12662){var _e__11814__auto__ = e12662;
return false;
}})();
...
}catch (e12670){var _e__11814__auto__ = e12670;
return false;
}})();
...
}catch (e12674){var _e__11814__auto__ = e12674;
return false;
}}
}
});
...
var vec__12699 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12699,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12699,(1),null);
...
return cljs.core.some((function (p1__12705_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12705_SHARP_);
}),template);
});
