...
var G__12614 = request;
var G__12615 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12614,G__12615) : ajax.formats.get_format.call(null,G__12614,G__12615));
} else {
...
return cljs.core.some((function (p1__12623_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12623_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12624){
var map__12625 = p__12624;
var map__12625__$1 = cljs.core.__destructure_map(map__12625);
var request = map__12625__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12629 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12629.cljs$core$IFn$_invoke$arity$1 ? fexpr__12629.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12629.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12632){
var map__12633 = p__12632;
var map__12633__$1 = cljs.core.__destructure_map(map__12633);
var request = map__12633__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12633__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12631_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12631_SHARP_);
