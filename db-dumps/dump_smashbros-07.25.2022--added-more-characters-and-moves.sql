...
SELECT pg_catalog.setval('public.attributes_group_seq', 17, true);
...
SELECT pg_catalog.setval('public.attributes_seq', 13, true);
...
46	Dark Dive	Leaps upward and, upon coming into contact with an opponent, latches onto them and discharges electricity before launching off of them with a dark explosion.	\N	\N	\N
47	Flame Choke	Lunges forward with his hand extended out and infused with dark magic. Upon contact, he grabs the opponents face and blasts them with a pulse of dark magic that drops them onto the ground	\N	\N	\N
48	Warlock Punch	Winds up his left arm while charging dark magic for 70 frames and then performs a powerful, dark magic-infused backfist.	\N	\N	\N
...
SELECT pg_catalog.setval('public.moves_id_seq', 48, true);
